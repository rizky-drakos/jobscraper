...
class itviecspider(scrapy.Spider):
    ...
    def parseInnerPage(self, response):
        yield {
            ...
            "location": response.css("div.job-details__overview > div:nth-child(3) > div > span::text").get(),
            "scraped_at": datetime.now().strftime('%Y-%m-%d %H:%M:%S'),
            "posted_at": response.css("div > div.job-details__overview > div.svg-icon.svg-icon--blue > div::text").get(),
            "three_reasons": response.css("div > div.job-details__top-reason-to-join-us > ul > li::text").getall(),
            "description": response.css("body > div.search-page__job-details > div > div:nth-child(7), div:nth-child(8) *::text").getall(),
            "required_skills": response.css("div.search-page__job-details > div > div:nth-child(9), div:nth-child(10) *::text").getall(),
